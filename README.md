...
### 테스트 계정
- 이메일 : `honeytousedb@gmail.com` <br>
- 비밀번호 : `Honeymoney1234!` <br>
...
> - <b>[로그인 시퀀스 다이어그램](#2-로그인-시퀀스-다이어그램)</b>
> - <b>[구글 소셜 로그인 시퀀스 다이어그램](#3-구글-소셜-로그인-시퀀스-다이어그램)</b>
...
<details>
<summary><i>트랜잭션 테스트 결과</i></summary>
